...
finalStrSub = finalStr.substring(0, str1.length);

// f. Now shout it loud and make the it upper case.
// Hint: Use the method .toUpperCase().

finalStrSubUp = finalStrSub.toUpperCase()
console.log(finalStrSubUp);
...
finalStrSubUpRep = finalStrSubUp.replace('.', '!');
console.log(finalStrSubUpRep);
